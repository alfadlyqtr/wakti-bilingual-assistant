/**
 * ============================================================================
 * SANDPACK PACKAGES — SINGLE SOURCE OF TRUTH (EDGE FUNCTION MIRROR)
 * ============================================================================
 *
 * Deno-compatible mirror of `src/config/sandpackPackages.ts`.
 * Used by the AI Coder system prompt so the model knows exactly which
 * packages are available in the Sandpack preview.
 *
 * ⚠️ KEEP IN SYNC with `src/config/sandpackPackages.ts`.
 *    Both files must contain the IDENTICAL list.
 *
 *    If you add or remove a package in the frontend, update this file in the
 *    same commit and redeploy the edge function.
 *
 * ============================================================================
 */
