...
// -----------------------------------------------------------------------------
...

  {
    ...
    form_schema_common: [
      ...
      { key: "instagram", label_en: "Instagram", label_ar: "إنستغرام", type: "text", required: false },
      { key: "whatsapp", label_en: "WhatsApp", label_ar: "واتساب", type: "text", required: false },
    ...
    form_schema_by_purpose: {
      student_cv: [
        ...
        FIELD_RAW_CONTENT("Paste projects, activities, and extra details", "الصق المشاريع والأنشطة والتفاصيل الإضافية", false),
      ],
      graduate_cv: [
        { key: "education", label_en: "Education", label_ar: "التعليم", type: "textarea", required: false },
