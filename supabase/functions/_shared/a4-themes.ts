...
export const A4_THEMES: A4Theme[] = [
  ...
  // 6. CRAFT INFOGRAPHIC -------------------------------------------------------
  {
    ...
    style_block:
      "Paper-craft flat-lay infographic aesthetic. Soft paper-texture background, hand-cut paper shapes with subtle drop shadows, hand-drawn ink arrows and labels, small tactile craft elements (folded paper, cotton clouds, twine, blue water drops). Warm, educational, hands-on feel.",
    layout_blueprint:
      "Top zone: paper-cut title card holding the topic text inside. Small meta strip below showing student name and subject when provided. Middle body: 3 to 4 paper-shape information cards arranged in a flowing vertical layout, each card holding a short label and one or two sentences of content. Hand-drawn ink arrows or twine lines connect cards in reading order. Bottom zone: final summary card or closing thought. Small 3D craft accents (folded paper, cotton clouds, water drops) scattered tastefully between cards without competing with text. All text on shapes stays razor-sharp and perfectly legible.",
