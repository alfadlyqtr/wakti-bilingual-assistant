-- Quick fix: Remove admin activity logging that's causing foreign key constraint errors
-- This allows activation to work immediately while we resolve the admin_users table structure
...
BEGIN
  ...
  -- NOTE: Admin activity logging temporarily removed to fix foreign key constraint error
  -- TODO: Re-implement once admin_users table structure is properly configured
