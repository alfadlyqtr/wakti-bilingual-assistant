        ...
        <div className="flex items-start gap-6">
          ...
          <div className="relative">
            <button
              ...
              className="w-16 h-16 rounded-full bg-[#060541]/5 dark:bg-white/5 border-2 border-dashed border-[#060541]/20 dark:border-white/20 overflow-hidden hover:border-[hsl(280,70%,65%)] hover:bg-[hsl(280,70%,65%)]/5 transition-all cursor-pointer"
            >
  ...
  const renderStyleTab = () => (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        {/* Color circles for quick template selection */}
        <div className="flex items-center gap-3 p-4 rounded-xl bg-[#fcfefd] dark:bg-[#0c0f14]/80 border border-[#060541]/10 dark:border-white/10">
          {CARD_TEMPLATES.map((template) => {
            ...
            return (
              <button
                ...
                className={`w-10 h-10 rounded-full ${template.preview} border-2 transition-all hover:scale-110 ${
                  isSelected 
                    ? 'border-white ring-2 ring-[hsl(210,100%,65%)]' 
                    : 'border-white/30'
                }`}
                aria-label={isRTL ? template.nameAr : template.name}
              />
            );
          })}
        </div>
...
const CardPreviewLive: React.FC<{ data: BusinessCardData }> = ({ data }) => {
    ...
    return (
      <div className="w-[300px] h-[384px] mx-auto rounded-[20px] bg-white shadow-xl flex flex-col items-center relative">
        ...
        <div className="w-full h-[192px] rounded-t-[20px] overflow-hidden">
          {data.coverPhotoUrl ? (
            ...
            <svg className="w-full h-full" viewBox="0 0 300 192" preserveAspectRatio="none">
              {/* Row 1 */}
              <polygon points="0,0 50,0 25,40" fill="#f5b5b5" />
              <polygon points="50,0 25,40 75,40" fill="#e8a4a4" />
              <polygon points="50,0 100,0 75,40" fill="#d4847d" />
              <polygon points="100,0 75,40 125,40" fill="#c97b7b" />
              <polygon points="100,0 150,0 125,40" fill="#e8a4a4" />
              <polygon points="150,0 125,40 175,40" fill="#f5b5b5" />
              <polygon points="150,0 200,0 175,40" fill="#d4847d" />
              <polygon points="200,0 175,40 225,40" fill="#c97b7b" />
              <polygon points="200,0 250,0 225,40" fill="#e8a4a4" />
              <polygon points="250,0 225,40 275,40" fill="#d4847d" />
              <polygon points="250,0 300,0 275,40" fill="#f5b5b5" />
              <polygon points="300,0 275,40 300,40" fill="#c97b7b" />
              {/* Row 2 */}
              <polygon points="0,40 25,40 0,80" fill="#d4847d" />
              <polygon points="25,40 0,80 50,80" fill="#c97b7b" />
              <polygon points="25,40 75,40 50,80" fill="#b86b6b" />
              <polygon points="75,40 50,80 100,80" fill="#d4847d" />
              <polygon points="75,40 125,40 100,80" fill="#c97b7b" />
              <polygon points="125,40 100,80 150,80" fill="#a85a5a" />
              <polygon points="125,40 175,40 150,80" fill="#b86b6b" />
              <polygon points="175,40 150,80 200,80" fill="#c97b7b" />
              <polygon points="175,40 225,40 200,80" fill="#d4847d" />
              <polygon points="225,40 200,80 250,80" fill="#b86b6b" />
              <polygon points="225,40 275,40 250,80" fill="#a85a5a" />
              <polygon points="275,40 250,80 300,80" fill="#c97b7b" />
              {/* Row 3 */}
              <polygon points="0,80 50,80 25,120" fill="#b86b6b" />
              <polygon points="50,80 25,120 75,120" fill="#a85a5a" />
              <polygon points="50,80 100,80 75,120" fill="#8b4545" />
              <polygon points="100,80 75,120 125,120" fill="#b86b6b" />
              <polygon points="100,80 150,80 125,120" fill="#a85a5a" />
              <polygon points="150,80 125,120 175,120" fill="#7a3a3a" />
              <polygon points="150,80 200,80 175,120" fill="#8b4545" />
              <polygon points="200,80 175,120 225,120" fill="#a85a5a" />
              <polygon points="200,80 250,80 225,120" fill="#b86b6b" />
              <polygon points="250,80 225,120 275,120" fill="#8b4545" />
              <polygon points="250,80 300,80 275,120" fill="#7a3a3a" />
              <polygon points="300,80 275,120 300,120" fill="#a85a5a" />
              {/* Row 4 */}
              <polygon points="0,120 25,120 0,160" fill="#8b4545" />
              <polygon points="25,120 0,160 50,160" fill="#7a3a3a" />
              <polygon points="25,120 75,120 50,160" fill="#6b2f2f" />
              <polygon points="75,120 50,160 100,160" fill="#8b4545" />
              <polygon points="75,120 125,120 100,160" fill="#7a3a3a" />
              <polygon points="125,120 100,160 150,160" fill="#5c2525" />
              <polygon points="125,120 175,120 150,160" fill="#6b2f2f" />
              <polygon points="175,120 150,160 200,160" fill="#7a3a3a" />
              <polygon points="175,120 225,120 200,160" fill="#8b4545" />
              <polygon points="225,120 200,160 250,160" fill="#6b2f2f" />
              <polygon points="225,120 275,120 250,160" fill="#5c2525" />
              <polygon points="275,120 250,160 300,160" fill="#7a3a3a" />
              {/* Bottom row */}
              <rect x="0" y="160" width="300" height="32" fill="#4d1f1f" />
            </svg>
          )}
        </div>
        
        {/* Avatar - Centered, overlapping */}
        <div className="absolute w-[114px] h-[114px] bg-white rounded-full flex justify-center items-center" style={{ top: 'calc(50% - 57px)' }}>
        ...
        <div className="flex gap-2 mt-4">
          <button className="px-4 py-1.5 border-2 border-black rounded text-[11px] font-bold uppercase bg-white text-black">
            Button
          </button>
          <button className="px-4 py-1.5 border-2 border-black rounded text-[11px] font-bold uppercase bg-black text-white">
            Button
          </button>
        </div>
      </div>
  ...
  if (template.headerStyle === 'professional') {
    return (
      <div className="w-[300px] mx-auto rounded-lg shadow-xl overflow-hidden bg-white flex flex-col items-center">
        {/* Avatar section with blue bands */}
        <div className="w-full pt-5 flex items-center justify-center flex-col gap-1">
          <div className="w-full flex items-center justify-center relative">
            {/* Top blue band */}
            <div className="absolute h-[6px] w-full bg-[#58b0e0] top-4" />
            {/* Bottom blue band */}
            <div className="absolute h-[6px] w-full bg-[#58b0e0] bottom-4" />
            {/* Avatar */}
            <div className="w-36 h-36 z-40 border-4 border-white rounded-full overflow-hidden">
              {data.profilePhotoUrl ? (
                <img src={data.profilePhotoUrl} alt="" className="w-full h-full object-cover" />
              ) : (
            ...
            <div className="absolute bg-[#58b0e0] z-10 w-full h-[60%]" />
          </div>
        </div>
        ...
        {/* Bottom blue bar */}
        <div className="w-full h-3 bg-[#58b0e0]" />
      </div>
    );
  }
    ...
    return (
      <div className="w-[300px] mx-auto rounded-lg shadow-xl overflow-hidden bg-white flex flex-col items-center py-8 px-6 gap-3 relative">
        ...
        <div className="absolute -left-[40%] top-0">
          <svg className="fill-gray-300 rotate-[24deg]" height="200" width="200" viewBox="0 0 24 24">
            <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
          </svg>
        </div>
        
        {/* Gray curved background */}
        <div className="absolute rounded-full bg-gray-500 z-20 left-1/2 top-[44%] h-[110%] w-[110%] -translate-x-1/2" />
        
        {/* Title */}
        <div className="uppercase text-center leading-none z-40">
          <p className="text-black font-semibold text-xs font-serif">{data.headline || 'Best'}</p>
          <p 
        ...
        {/* Photo */}
        <div className="w-[180px] aspect-square bg-gray-100 z-40 rounded-md overflow-hidden">
          {data.profilePhotoUrl ? (
            <img src={data.profilePhotoUrl} alt="" className="w-full h-full object-cover" />
          ) : (
  ...
  if (template.headerStyle === 'minimal') {
    return (
      <div className="w-[300px] mx-auto rounded-[20px] shadow-2xl overflow-hidden bg-black flex flex-col">
        {/* Header with cover */}
        <div className="h-24 bg-gradient-to-br from-gray-900 to-black relative">
          {data.coverPhotoUrl && (
            <img src={data.coverPhotoUrl} alt="Cover" className="w-full h-full object-cover opacity-50" />
          )}
          {/* Logo */}
          {data.logoUrl && (
            <div className="absolute top-3 right-3 w-10 h-10 rounded-lg bg-white/10 p-1">
        ...
        <div className="text-center mt-3 px-5">
          <h3 
            ...
            style={{ color: data.nameStyle?.color || '#fff' }}
          >
          ...
          <p 
            ...
            style={{ color: data.titleStyle?.color || '#666' }}
          >
        ...
        {(data.socialLinks || []).length > 0 && (
          <div className="flex items-center justify-center gap-3 pb-5 border-t border-gray-800 pt-3 mx-5">
            {(data.socialLinks || []).slice(0, 5).map((link) => {
              const platform = SOCIAL_PLATFORMS.find(p => p.type === link.type);
              const Icon = platform?.icon || Link2;
              return (
                <div key={link.id} className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center">
  ...
  return (
    <div className="w-[300px] mx-auto rounded-[20px] shadow-xl overflow-hidden bg-white flex flex-col">
      {/* Header */}
      <div className="h-20 bg-gray-50 relative flex items-center justify-center">
        {data.coverPhotoUrl ? (
          <img src={data.coverPhotoUrl} alt="Cover" className="w-full h-full object-cover" />
        ) : (
      ...
      {/* Avatar - overlapping */}
      <div className="flex justify-start px-5 -mt-8">
        <div className="w-16 h-16 rounded-full border-4 border-white overflow-hidden bg-gray-200 shadow-lg">
          {data.profilePhotoUrl ? (
            <img src={data.profilePhotoUrl} alt="" className="w-full h-full object-cover" />
          ) : (
      ...
      <div className="px-5 mt-3">
        <h3 
          ...
          style={{ color: data.nameStyle?.color || '#1f2937' }}
        >
          {data.firstName || 'Your'} {data.lastName || 'Name'}
        </h3>
        <p 
          className={`text-sm text-gray-500 ${getTextStyleClasses(data.titleStyle)}`}
          style={{ color: data.titleStyle?.color || '#6b7280' }}
        >
          {data.jobTitle || 'Job Title'}
        </p>
      </div>
      ...
      {(data.socialLinks || []).length > 0 && (
        <div className="flex items-center gap-2 px-5 pb-4">
          {(data.socialLinks || []).slice(0, 5).map((link) => {
            ...
            const Icon = platform?.icon || Link2;
            return (
              <div key={link.id} className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center">
