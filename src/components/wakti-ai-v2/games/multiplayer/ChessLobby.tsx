        ...
        <div className="mx-auto max-w-md">
          <div className="rounded-3xl border border-[#E9CEB0]/30 bg-white p-6 shadow-[0_8px_32px_rgba(6,5,65,0.08)] dark:border-white/10 dark:bg-gradient-to-br dark:from-[#1a1d26] dark:via-[#161921] dark:to-[#11131a] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
            ...
            <div className="space-y-5">
              ...
              <div>
                <Label className="mb-2 block text-sm font-medium text-[#060541] dark:text-white">{isAr ? 'اختر لونك' : 'Choose your color'}</Label>
                <div className="grid grid-cols-2 gap-3">
                  <button
                    onClick={() => setColor('white')}
                    className={`flex items-center justify-center gap-2 rounded-xl py-3 font-medium transition-all ${
                      color === 'white'
                        ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-[0_4px_14px_rgba(37,99,235,0.3)]'
                  ...
                  >
                    <span className="text-lg">⚪</span> {isAr ? 'أبيض' : 'White'}
                  </button>
                  <button
                  ...
                  >
                    <span className="text-lg">⚫</span> {isAr ? 'أسود' : 'Black'}
                  </button>
                </div>
              </div>
              ...
              <button
                ...
                disabled={busy}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 py-4 text-base font-semibold text-white shadow-[0_4px_16px_rgba(37,99,235,0.3)] transition-all duration-200 hover:shadow-[0_8px_24px_rgba(37,99,235,0.4)] hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:hover:translate-y-0"
              >
