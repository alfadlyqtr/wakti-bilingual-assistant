...
import { Bot, Users, Grid3x3 } from 'lucide-react';
...
export function TicTacToeTab({ inviteCode = null, inviteLaunchToken = null, onInviteCodeConsumed, onRegisterGameExitHandler }: TicTacToeTabProps) {
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-white/70">{isAr ? 'تدرب وطور مهاراتك' : 'Practice and improve your skills'}</div>
              </div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-[#060541]/50 dark:text-white/40">{isAr ? 'تحدي أصدقائك في الوقت الحقيقي' : 'Challenge friends in real-time'}</div>
              </div>
