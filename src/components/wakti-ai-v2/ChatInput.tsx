                        ...
                        >
                          <div className="pointer-events-auto rounded-xl border border-white/70 dark:border-white/10 bg-white/95 dark:bg-neutral-900/90 backdrop-blur-xl shadow-[0_10px_28px_rgba(0,0,0,0.12)] ring-1 ring-white/25 dark:ring-white/5 px-2 py-1 flex items-center gap-2 overflow-hidden">
                            ...
                            <motion.button
                              ...
                              onPointerUp={() => { onTriggerChange && onTriggerChange('chat'); onChatSubmodeChange?.('study'); setShowQuickModes(false); }}
                              className="inline-flex items-center gap-2 rounded-lg px-3 py-1.5 bg-purple-600 text-white text-xs font-semibold shadow -ml-0.5"
                              type="button"
                            >
                              <span className="text-sm leading-none">📚</span>
                              <span>{language === 'ar' ? 'دراسة' : 'Study'}</span>
                            </motion.button>
                          </div>
                        </motion.div>
                      )}
