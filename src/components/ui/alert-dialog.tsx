  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        role="alertdialog"
        aria-labelledby={React.isValidElement(title) ? 'alert-dialog-title' : undefined}
        aria-describedby={React.isValidElement(description) ? 'alert-dialog-description' : undefined}
        {...props}
      >
        {React.Children.map(children, (child) => {
          if (React.isValidElement(child)) {
            // Add id to title and description for a11y
