...
export const WAKTI_CAPABILITIES: WaktiCapability[] = [
  ...
  },
  {
    ...
    supportLevel: 'full_operator',
    supportSummaryEn: 'Operator can now open the correct text tab and prepare compose or reply drafts, while advanced generation still finishes inside the Text Tools page.',
    supportSummaryAr: 'يستطيع المشغّل الآن فتح تبويب النص الصحيح وتجهيز مسودات التأليف أو الرد، بينما يبقى الإكمال المتقدم داخل صفحة أدوات النص نفسها.',
  },
  {
    id: 'voice_studio',
    category: 'creation',
