export const miscAr = {
  ...
  imageGenTitle: "مولّد الصور",
  imageGenDesc: "حوّل النص إلى صور جميلة خلال ثوانٍ. اختر الأسلوب، عدّل التفاصيل، حسّن الدقة، وصدّر بصيغ جاهزة للمشاركة.",
  ...
  vitalityTitle: "الحيوية",
  vitalityDesc: "تتبع الطاقة والنوم وإشارات العافية. شاهد الاتجاهات واحصل على تلميحات ذكية لتحسين الأداء والشعور.",
  journalTitle: "دفتر يوميات وقطي",
  journalDesc: "سجل يومك ومزاجك وأنشطتك. احصل على لمحات لطيفة واسأل الدفتر عن أنماطك.",
  smartTextTitle: "مولّد النص الذكي",
  smartTextDesc: "اكتب رسائل، منشورات، ملخصات وتقارير خلال ثوانٍ. قصيرة، مفصلة، أو خطوة بخطوة — كما تريد.",
  aiGamesTitle: "ألعاب الذكاء الاصطناعي",
  aiGamesDesc: "العب ألعاباً ذهنية سريعة مع خصوم بالذكاء الاصطناعي وتدريب ودي. ممتعة وتحدٍّ وإمكانية إعادة فورية.",
  voiceCloningTitle: "استنساخ الصوت",
  voiceCloningDesc: "انسخ صوتك لتحويل النص إلى كلام طبيعي. أنشئ قراءات أو إرشادات أو رسائل بصوت يشبهك.",
  musicGenTitle: "توليد الموسيقى",
  musicGenDesc: "أنشئ مقاطع خلفية وأجواء للفيديوهات أو المناسبات أو جلسات التركيز. تصدير ومشاركة بسهولة.",
  voiceTranslationTitle: "ترجمة الصوت",
  voiceTranslationDesc: "ترجمة الحديث باتجاهين بأصوات طبيعية. جسّر اللغات في الوقت الفعلي.",
