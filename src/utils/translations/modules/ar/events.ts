...
export const eventsAr = {
  ...
  // Location picker (AR)
  pickLocationButton: "اختر الموقع",
  enterLocationPlaceholder: "أدخل اسم الموقع للعرض",
  googleMapsPlaceholder: "https://maps.google.com/...",
  pasteMapsHint: "أو قم بلصق رابط خرائط جوجل أعلاه",
  mapLinkAdded: "تم إضافة رابط الخريطة",
  pickLocationTitle: "اختيار الموقع",
  searchPlaces: "ابحث عن الأماكن",
  goToPlace: "اذهب إلى هذا المكان",
  go: "اذهب",
  useMyLocation: "استخدم موقعي",
  dragPinHint: "اسحب الدبوس لضبط الموضع بدقة.",
