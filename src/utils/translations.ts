...
export function t(key: TranslationKey, lang: string): string {
  const translations = {
    ...
    ar: {
      ...
      trialEndsIn: "تنتهي النسخة التجريبية في",
      days: "أيام",
      ...
      feedback: "تعليق",
      feedbackPlaceholder: "مساحة التعليق",
      ...
      trialReminder: "تذكير النسخة التجريبية",
      ...
      transcribingAudio: "كتابة نص الصوت",
      ...
      mp3orWavFormat: "بتنسيق MP3 أو WAV",
