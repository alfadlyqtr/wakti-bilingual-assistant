...
import { BarChart3, ArrowLeft, TrendingUp, DollarSign, Users, Calendar } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-background text-foreground">
      ...
      <header className="sticky top-0 z-50 bg-gradient-nav backdrop-blur-xl border-b border-border/50 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-enhanced-heading">Analytics Dashboard</h1>
              <p className="text-sm text-muted-foreground">Revenue tracking and user analytics</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="p-6">
        {/* Revenue Analytics */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-enhanced-heading mb-6">Revenue Analytics</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="enhanced-card">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-enhanced-heading">
        ...
        {/* User Analytics */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-enhanced-heading mb-6">User Analytics</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="enhanced-card">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-enhanced-heading">{analytics.totalUsers}</div>
            ...
            <Card className="enhanced-card">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-enhanced-heading">{analytics.newUsersThisMonth}</div>
            ...
            <Card className="enhanced-card">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-enhanced-heading">{analytics.dailyActiveUsers}</div>
            ...
            <Card className="enhanced-card">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-enhanced-heading">{analytics.activeSubscriptions}</div>
        ...
        {/* Growth Metrics */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-enhanced-heading mb-6">Growth Metrics</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="enhanced-card">
              <CardHeader>
              ...
              <CardContent>
                <div className="flex items-center space-x-2">
                  ...
                  <TrendingUp className={`h-5 w-5 ${analytics.subscriptionGrowth >= 0 ? 'text-accent-green' : 'text-red-500'}`} />
                </div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-4 bg-gradient-secondary/10 rounded-lg">
                <div className="text-lg font-semibold text-enhanced-heading">
